...
export const AuthProvider: FC = ({ children }) => {
  ...
  useEffect(() => {
    const initAuth0 = async () => {
      ...
      /*
      We call the Auth0 client handleRedirectCallback function, which will
      parse the URL, extract the code, and store it in a variable
      internally. We also redirect the user to the home page after this
      has been completed.
      */
      if (
